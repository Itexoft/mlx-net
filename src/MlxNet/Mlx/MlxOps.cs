...
public static unsafe partial class MlxOps
{
    ...
    public static partial int Abs(out MlxArrayHandle res, MlxArrayHandle a, MlxStreamHandle s);
    ...
    public static partial int Add(out MlxArrayHandle res, MlxArrayHandle a, MlxArrayHandle b, MlxStreamHandle s);
    ...
    public static partial int All(out MlxArrayHandle res, MlxArrayHandle a, [MarshalAs(UnmanagedType.I1)] bool keepdims, MlxStreamHandle s);
    ...
    public static partial int Allclose(
        ...
        double rtol,
        double atol,
        [MarshalAs(UnmanagedType.I1)] bool equalNan,
        MlxStreamHandle s);
    ...
    public static partial int Any(out MlxArrayHandle res, MlxArrayHandle a, [MarshalAs(UnmanagedType.I1)] bool keepdims, MlxStreamHandle s);
    ...
    public static partial int Arange(out MlxArrayHandle res, double start, double stop, double step, MlxDType dtype, MlxStreamHandle s);
    ...
    public static partial int Arccos(out MlxArrayHandle res, MlxArrayHandle a, MlxStreamHandle s);
    ...
    public static partial int Arccosh(out MlxArrayHandle res, MlxArrayHandle a, MlxStreamHandle s);
    ...
    public static partial int Arcsin(out MlxArrayHandle res, MlxArrayHandle a, MlxStreamHandle s);
    ...
    public static partial int Arcsinh(out MlxArrayHandle res, MlxArrayHandle a, MlxStreamHandle s);
    ...
    public static partial int Arctan(out MlxArrayHandle res, MlxArrayHandle a, MlxStreamHandle s);
    ...
    public static partial int Arctan2(out MlxArrayHandle res, MlxArrayHandle a, MlxArrayHandle b, MlxStreamHandle s);
    ...
    public static partial int Arctanh(out MlxArrayHandle res, MlxArrayHandle a, MlxStreamHandle s);
    ...
    public static partial int Argmax(out MlxArrayHandle res, MlxArrayHandle a, [MarshalAs(UnmanagedType.I1)] bool keepdims, MlxStreamHandle s);
    ...
    public static partial int Argmin(out MlxArrayHandle res, MlxArrayHandle a, [MarshalAs(UnmanagedType.I1)] bool keepdims, MlxStreamHandle s);
    ...
    public static partial int ArgpartitionAxis(out MlxArrayHandle res, MlxArrayHandle a, int kth, int axis, MlxStreamHandle s);
    ...
    public static partial int Argpartition(out MlxArrayHandle res, MlxArrayHandle a, int kth, MlxStreamHandle s);
    ...
    public static partial int ArgsortAxis(out MlxArrayHandle res, MlxArrayHandle a, int axis, MlxStreamHandle s);
    ...
    public static partial int Argsort(out MlxArrayHandle res, MlxArrayHandle a, MlxStreamHandle s);
    ...
    public static partial int Astype(out MlxArrayHandle res, MlxArrayHandle a, MlxDType dtype, MlxStreamHandle s);
    ...
    public static partial int Atleast1D(out MlxArrayHandle res, MlxArrayHandle a, MlxStreamHandle s);
    ...
    public static partial int Atleast2D(out MlxArrayHandle res, MlxArrayHandle a, MlxStreamHandle s);
    ...
    public static partial int Atleast3D(out MlxArrayHandle res, MlxArrayHandle a, MlxStreamHandle s);

    /// <summary>Computes the bitwise AND of two arrays element-wise.</summary>
    [LibraryImport(Common.Lib, EntryPoint = "mlx_bitwise_and")]
    public static partial int BitwiseAnd(out MlxArrayHandle res, MlxArrayHandle a, MlxArrayHandle b, MlxStreamHandle s);
    ...
    public static partial int BitwiseInvert(out MlxArrayHandle res, MlxArrayHandle a, MlxStreamHandle s);

    /// <summary>Computes the bitwise OR of two arrays element-wise.</summary>
    [LibraryImport(Common.Lib, EntryPoint = "mlx_bitwise_or")]
    public static partial int BitwiseOr(out MlxArrayHandle res, MlxArrayHandle a, MlxArrayHandle b, MlxStreamHandle s);

    /// <summary>Computes the bitwise XOR of two arrays element-wise.</summary>
    [LibraryImport(Common.Lib, EntryPoint = "mlx_bitwise_xor")]
    public static partial int BitwiseXor(out MlxArrayHandle res, MlxArrayHandle a, MlxArrayHandle b, MlxStreamHandle s);
    ...
    public static partial int BlockMaskedMm(
        ...
        MlxArrayHandle b,
        int blockSize,
        MlxArrayHandle maskOut,
        MlxArrayHandle maskLhs,
        MlxArrayHandle maskRhs,
        MlxStreamHandle s);
    ...
    public static partial int BroadcastArrays(out MlxVectorArrayHandle res, MlxVectorArrayHandle inputs, MlxStreamHandle s);
    ...
    public static partial int BroadcastTo(out MlxArrayHandle res, MlxArrayHandle a, int* shape, nuint shapeNum, MlxStreamHandle s);
    ...
    public static partial int Ceil(out MlxArrayHandle res, MlxArrayHandle a, MlxStreamHandle s);
    ...
    public static partial int Clip(out MlxArrayHandle res, MlxArrayHandle a, MlxArrayHandle aMin, MlxArrayHandle aMax, MlxStreamHandle s);
    ...
    public static partial int ConcatenateAxis(out MlxArrayHandle res, MlxVectorArrayHandle arrays, int axis, MlxStreamHandle s);
    ...
    public static partial int Concatenate(out MlxArrayHandle res, MlxVectorArrayHandle arrays, MlxStreamHandle s);
    ...
    public static partial int Conjugate(out MlxArrayHandle res, MlxArrayHandle a, MlxStreamHandle s);
    ...
    public static partial int Contiguous(
        out MlxArrayHandle res,
        MlxArrayHandle a,
        [MarshalAs(UnmanagedType.I1)] bool allowColMajor,
        MlxStreamHandle s);
    ...
    public static partial int ConvGeneral(
        ...
        nuint paddingHiNum,
        int* kernelDilation,
        nuint kernelDilationNum,
        int* inputDilation,
        nuint inputDilationNum,
        int groups,
    ...
    public static partial int Copy(out MlxArrayHandle res, MlxArrayHandle a, MlxStreamHandle s);
    ...
    public static partial int Cos(out MlxArrayHandle res, MlxArrayHandle a, MlxStreamHandle s);

    /// <summary>Computes the element-wise hyperbolic cosine of the input.</summary>
    [LibraryImport(Common.Lib, EntryPoint = "mlx_cosh")]
    public static partial int Cosh(out MlxArrayHandle res, MlxArrayHandle a, MlxStreamHandle s);
    ...
    public static partial int Degrees(out MlxArrayHandle res, MlxArrayHandle a, MlxStreamHandle s);
    ...
    public static partial int Depends(out MlxVectorArrayHandle res, MlxVectorArrayHandle inputs, MlxVectorArrayHandle dependencies);
    ...
    public static partial int Diag(out MlxArrayHandle res, MlxArrayHandle a, int k, MlxStreamHandle s);
    ...
    public static partial int Diagonal(out MlxArrayHandle res, MlxArrayHandle a, int offset, int axis1, int axis2, MlxStreamHandle s);
    ...
    public static partial int Divide(out MlxArrayHandle res, MlxArrayHandle a, MlxArrayHandle b, MlxStreamHandle s);

    /// <summary>Computes element-wise quotient and remainder of division.</summary>
    [LibraryImport(Common.Lib, EntryPoint = "mlx_divmod")]
    public static partial int Divmod(out MlxVectorArrayHandle res, MlxArrayHandle a, MlxArrayHandle b, MlxStreamHandle s);
    ...
    public static partial int Equal(out MlxArrayHandle res, MlxArrayHandle a, MlxArrayHandle b, MlxStreamHandle s);

    /// <summary>Computes the Gaussian error function of each element.</summary>
    [LibraryImport(Common.Lib, EntryPoint = "mlx_erf")]
    public static partial int Erf(out MlxArrayHandle res, MlxArrayHandle a, MlxStreamHandle s);

    /// <summary>Computes the inverse error function of each element.</summary>
    [LibraryImport(Common.Lib, EntryPoint = "mlx_erfinv")]
    public static partial int Erfinv(out MlxArrayHandle res, MlxArrayHandle a, MlxStreamHandle s);

    /// <summary>Computes the element-wise exponential.</summary>
    [LibraryImport(Common.Lib, EntryPoint = "mlx_exp")]
    public static partial int Exp(out MlxArrayHandle res, MlxArrayHandle a, MlxStreamHandle s);
    ...
    public static partial int ExpandDimsAxes(out MlxArrayHandle res, MlxArrayHandle a, int* axes, nuint axesNum, MlxStreamHandle s);

    /// <summary>Inserts a new axis of length 1 at the given position.</summary>
    [LibraryImport(Common.Lib, EntryPoint = "mlx_expand_dims")]
    public static partial int ExpandDims(out MlxArrayHandle res, MlxArrayHandle a, int axis, MlxStreamHandle s);

    /// <summary>Computes exp(x) - 1 with improved precision for small x.</summary>
    [LibraryImport(Common.Lib, EntryPoint = "mlx_expm1")]
    public static partial int Expm1(out MlxArrayHandle res, MlxArrayHandle a, MlxStreamHandle s);

    /// <summary>Creates a 2-D identity matrix with ones on the diagonal.</summary>
    [LibraryImport(Common.Lib, EntryPoint = "mlx_eye")]
    public static partial int Eye(out MlxArrayHandle res, int n, int m, int k, MlxDType dtype, MlxStreamHandle s);

    /// <summary>Flattens the array into 1-D between the specified axes.</summary>
    [LibraryImport(Common.Lib, EntryPoint = "mlx_flatten")]
    public static partial int Flatten(out MlxArrayHandle res, MlxArrayHandle a, int startAxis, int endAxis, MlxStreamHandle s);

    /// <summary>Rounds each element down to the nearest integer.</summary>
    [LibraryImport(Common.Lib, EntryPoint = "mlx_floor")]
    public static partial int Floor(out MlxArrayHandle res, MlxArrayHandle a, MlxStreamHandle s);
    ...
    public static partial int FloorDivide(out MlxArrayHandle res, MlxArrayHandle a, MlxArrayHandle b, MlxStreamHandle s);
    ...
    public static partial int Full(out MlxArrayHandle res, int* shape, nuint shapeNum, MlxArrayHandle vals, MlxDType dtype, MlxStreamHandle s);
    ...
    public static partial int GatherMm(
        ...
        MlxArrayHandle a,
        MlxArrayHandle b,
        MlxArrayHandle lhsIndices,
        MlxArrayHandle rhsIndices,
        [MarshalAs(UnmanagedType.I1)] bool sortedIndices,
        MlxStreamHandle s);
    ...
    public static partial int SegmentedMm(out MlxArrayHandle res, MlxArrayHandle a, MlxArrayHandle b, MlxArrayHandle segments, MlxStreamHandle s);

    /// <summary>Returns a boolean array where a is greater than b.</summary>
    [LibraryImport(Common.Lib, EntryPoint = "mlx_greater")]
    public static partial int Greater(out MlxArrayHandle res, MlxArrayHandle a, MlxArrayHandle b, MlxStreamHandle s);
    ...
    public static partial int GreaterEqual(out MlxArrayHandle res, MlxArrayHandle a, MlxArrayHandle b, MlxStreamHandle s);
    ...
    public static partial int HadamardTransform(out MlxArrayHandle res, MlxArrayHandle a, MlxOptionalFloat scale, MlxStreamHandle s);

    /// <summary>Returns an identity matrix of given size.</summary>
    [LibraryImport(Common.Lib, EntryPoint = "mlx_identity")]
    public static partial int Identity(out MlxArrayHandle res, int n, MlxDType dtype, MlxStreamHandle s);

    /// <summary>Returns the imaginary component of each element.</summary>
    [LibraryImport(Common.Lib, EntryPoint = "mlx_imag")]
    public static partial int Imag(out MlxArrayHandle res, MlxArrayHandle a, MlxStreamHandle s);

    /// <summary>Computes the inner product of two arrays.</summary>
    [LibraryImport(Common.Lib, EntryPoint = "mlx_inner")]
    public static partial int Inner(out MlxArrayHandle res, MlxArrayHandle a, MlxArrayHandle b, MlxStreamHandle s);
    ...
    public static partial int Isfinite(out MlxArrayHandle res, MlxArrayHandle a, MlxStreamHandle s);

    /// <summary>Indicates which elements are positive or negative infinity.</summary>
    [LibraryImport(Common.Lib, EntryPoint = "mlx_isinf")]
    public static partial int Isinf(out MlxArrayHandle res, MlxArrayHandle a, MlxStreamHandle s);

    /// <summary>Indicates which elements are NaN.</summary>
    [LibraryImport(Common.Lib, EntryPoint = "mlx_isnan")]
    public static partial int Isnan(out MlxArrayHandle res, MlxArrayHandle a, MlxStreamHandle s);

    /// <summary>Indicates which elements are negative infinity.</summary>
    [LibraryImport(Common.Lib, EntryPoint = "mlx_isneginf")]
    public static partial int Isneginf(out MlxArrayHandle res, MlxArrayHandle a, MlxStreamHandle s);

    /// <summary>Indicates which elements are positive infinity.</summary>
    [LibraryImport(Common.Lib, EntryPoint = "mlx_isposinf")]
    public static partial int Isposinf(out MlxArrayHandle res, MlxArrayHandle a, MlxStreamHandle s);

    /// <summary>Computes the Kronecker product of two arrays.</summary>
    [LibraryImport(Common.Lib, EntryPoint = "mlx_kron")]
    public static partial int Kron(out MlxArrayHandle res, MlxArrayHandle a, MlxArrayHandle b, MlxStreamHandle s);

    /// <summary>Performs element-wise left bit shift.</summary>
    [LibraryImport(Common.Lib, EntryPoint = "mlx_left_shift")]
    public static partial int LeftShift(out MlxArrayHandle res, MlxArrayHandle a, MlxArrayHandle b, MlxStreamHandle s);

    /// <summary>Returns a boolean array where a is less than b.</summary>
    [LibraryImport(Common.Lib, EntryPoint = "mlx_less")]
    public static partial int Less(out MlxArrayHandle res, MlxArrayHandle a, MlxArrayHandle b, MlxStreamHandle s);
    ...
    public static partial int LessEqual(out MlxArrayHandle res, MlxArrayHandle a, MlxArrayHandle b, MlxStreamHandle s);

    /// <summary>Returns evenly spaced numbers over a specified interval.</summary>
    [LibraryImport(Common.Lib, EntryPoint = "mlx_linspace")]
    public static partial int Linspace(out MlxArrayHandle res, double start, double stop, int num, MlxDType dtype, MlxStreamHandle s);

    /// <summary>Computes the natural logarithm of each element.</summary>
    [LibraryImport(Common.Lib, EntryPoint = "mlx_log")]
    public static partial int Log(out MlxArrayHandle res, MlxArrayHandle a, MlxStreamHandle s);

    /// <summary>Computes the base-10 logarithm of each element.</summary>
    [LibraryImport(Common.Lib, EntryPoint = "mlx_log10")]
    public static partial int Log10(out MlxArrayHandle res, MlxArrayHandle a, MlxStreamHandle s);

    /// <summary>Computes log(1 + x) for each element.</summary>
    [LibraryImport(Common.Lib, EntryPoint = "mlx_log1p")]
    public static partial int Log1P(out MlxArrayHandle res, MlxArrayHandle a, MlxStreamHandle s);

    /// <summary>Computes the base-2 logarithm of each element.</summary>
    [LibraryImport(Common.Lib, EntryPoint = "mlx_log2")]
    public static partial int Log2(out MlxArrayHandle res, MlxArrayHandle a, MlxStreamHandle s);
    ...
    public static partial int Logaddexp(out MlxArrayHandle res, MlxArrayHandle a, MlxArrayHandle b, MlxStreamHandle s);
    ...
    public static partial int LogicalAnd(out MlxArrayHandle res, MlxArrayHandle a, MlxArrayHandle b, MlxStreamHandle s);

    /// <summary>Computes the logical NOT of each element.</summary>
    [LibraryImport(Common.Lib, EntryPoint = "mlx_logical_not")]
    public static partial int LogicalNot(out MlxArrayHandle res, MlxArrayHandle a, MlxStreamHandle s);

    /// <summary>Computes the element-wise logical OR of two arrays.</summary>
    [LibraryImport(Common.Lib, EntryPoint = "mlx_logical_or")]
    public static partial int LogicalOr(out MlxArrayHandle res, MlxArrayHandle a, MlxArrayHandle b, MlxStreamHandle s);
    ...
    public static partial int Logsumexp(out MlxArrayHandle res, MlxArrayHandle a, [MarshalAs(UnmanagedType.I1)] bool keepdims, MlxStreamHandle s);

    /// <summary>Performs matrix multiplication of two arrays.</summary>
    [LibraryImport(Common.Lib, EntryPoint = "mlx_matmul")]
    public static partial int Matmul(out MlxArrayHandle res, MlxArrayHandle a, MlxArrayHandle b, MlxStreamHandle s);
    ...
    public static partial int Max(out MlxArrayHandle res, MlxArrayHandle a, [MarshalAs(UnmanagedType.I1)] bool keepdims, MlxStreamHandle s);

    /// <summary>Element-wise maximum of two arrays.</summary>
    [LibraryImport(Common.Lib, EntryPoint = "mlx_maximum")]
    public static partial int Maximum(out MlxArrayHandle res, MlxArrayHandle a, MlxArrayHandle b, MlxStreamHandle s);
    ...
    public static partial int Mean(out MlxArrayHandle res, MlxArrayHandle a, [MarshalAs(UnmanagedType.I1)] bool keepdims, MlxStreamHandle s);
    ...
    public static partial int Min(out MlxArrayHandle res, MlxArrayHandle a, [MarshalAs(UnmanagedType.I1)] bool keepdims, MlxStreamHandle s);

    /// <summary>Computes the element-wise minimum of two arrays.</summary>
    [LibraryImport(Common.Lib, EntryPoint = "mlx_minimum")]
    public static partial int Minimum(out MlxArrayHandle res, MlxArrayHandle a, MlxArrayHandle b, MlxStreamHandle s);

    /// <summary>Moves an axis from one position to another in the array.</summary>
    [LibraryImport(Common.Lib, EntryPoint = "mlx_moveaxis")]
    public static partial int Moveaxis(out MlxArrayHandle res, MlxArrayHandle a, int source, int destination, MlxStreamHandle s);

    /// <summary>Computes the element-wise product of two arrays.</summary>
    [LibraryImport(Common.Lib, EntryPoint = "mlx_multiply")]
    public static partial int Multiply(out MlxArrayHandle res, MlxArrayHandle a, MlxArrayHandle b, MlxStreamHandle s);
    ...
    public static partial int Negative(out MlxArrayHandle res, MlxArrayHandle a, MlxStreamHandle s);

    /// <summary>Returns a boolean array of element-wise inequality.</summary>
    [LibraryImport(Common.Lib, EntryPoint = "mlx_not_equal")]
    public static partial int NotEqual(out MlxArrayHandle res, MlxArrayHandle a, MlxArrayHandle b, MlxStreamHandle s);
    ...
    public static partial int Ones(out MlxArrayHandle res, int* shape, nuint shapeNum, MlxDType dtype, MlxStreamHandle s);
    ...
    public static partial int OnesLike(out MlxArrayHandle res, MlxArrayHandle a, MlxStreamHandle s);

    /// <summary>Computes the outer product of two one-dimensional arrays.</summary>
    [LibraryImport(Common.Lib, EntryPoint = "mlx_outer")]
    public static partial int Outer(out MlxArrayHandle res, MlxArrayHandle a, MlxArrayHandle b, MlxStreamHandle s);
    ...
    public static partial int Pad(
        ...
        nuint lowPadSizeNum,
        int* highPadSize,
        nuint highPadSizeNum,
        MlxArrayHandle padValue,
        [MarshalAs(UnmanagedType.LPUTF8Str)] string mode,
        MlxStreamHandle s);
    ...
    public static partial int PartitionAxis(out MlxArrayHandle res, MlxArrayHandle a, int kth, int axis, MlxStreamHandle s);
    ...
    public static partial int Partition(out MlxArrayHandle res, MlxArrayHandle a, int kth, MlxStreamHandle s);

    /// <summary>Raises one array to the power of another, element-wise.</summary>
    [LibraryImport(Common.Lib, EntryPoint = "mlx_power")]
    public static partial int Power(out MlxArrayHandle res, MlxArrayHandle a, MlxArrayHandle b, MlxStreamHandle s);
    ...
    public static partial int Prod(out MlxArrayHandle res, MlxArrayHandle a, [MarshalAs(UnmanagedType.I1)] bool keepdims, MlxStreamHandle s);
    ...
    public static partial int Qqmm(
        ...
        MlxArrayHandle x,
        MlxArrayHandle w,
        MlxArrayHandle wScales,
        MlxOptionalInt groupSize,
        MlxOptionalInt bits,
        [MarshalAs(UnmanagedType.LPUTF8Str)] string mode,
        MlxArrayHandle globalScaleX,
        MlxArrayHandle globalScaleW,
        MlxStreamHandle s);

    /// <summary>Constructs a Bartlett window.</summary>
    [LibraryImport(Common.Lib, EntryPoint = "mlx_bartlett")]
    public static partial int Bartlett(out MlxArrayHandle res, int m, MlxStreamHandle s);

    /// <summary>Constructs a Blackman window.</summary>
    [LibraryImport(Common.Lib, EntryPoint = "mlx_blackman")]
    public static partial int Blackman(out MlxArrayHandle res, int m, MlxStreamHandle s);

    /// <summary>Converts FP8 values to the requested dtype.</summary>
    [LibraryImport(Common.Lib, EntryPoint = "mlx_from_fp8")]
    public static partial int FromFp8(out MlxArrayHandle res, MlxArrayHandle x, MlxDType dtype, MlxStreamHandle s);
    ...
    public static partial int FullLike(out MlxArrayHandle res, MlxArrayHandle a, MlxArrayHandle vals, MlxDType dtype, MlxStreamHandle s);
    ...
    public static partial int Hamming(out MlxArrayHandle res, int m, MlxStreamHandle s);

    /// <summary>Constructs a Hann window.</summary>
    [LibraryImport(Common.Lib, EntryPoint = "mlx_hanning")]
    public static partial int Hanning(out MlxArrayHandle res, int m, MlxStreamHandle s);
    ...
    public static partial int MaskedScatter(out MlxArrayHandle res, MlxArrayHandle a, MlxArrayHandle mask, MlxArrayHandle src, MlxStreamHandle s);
    ...
    public static partial int ToFp8(out MlxArrayHandle res, MlxArrayHandle x, MlxStreamHandle s);

    /// <summary>Converts each element from degrees to radians.</summary>
    [LibraryImport(Common.Lib, EntryPoint = "mlx_radians")]
    public static partial int Radians(out MlxArrayHandle res, MlxArrayHandle a, MlxStreamHandle s);

    /// <summary>Returns the real part of a complex array.</summary>
    [LibraryImport(Common.Lib, EntryPoint = "mlx_real")]
    public static partial int Real(out MlxArrayHandle res, MlxArrayHandle a, MlxStreamHandle s);

    /// <summary>Computes the reciprocal of each element.</summary>
    [LibraryImport(Common.Lib, EntryPoint = "mlx_reciprocal")]
    public static partial int Reciprocal(out MlxArrayHandle res, MlxArrayHandle a, MlxStreamHandle s);

    /// <summary>Computes the element-wise remainder of division.</summary>
    [LibraryImport(Common.Lib, EntryPoint = "mlx_remainder")]
    public static partial int Remainder(out MlxArrayHandle res, MlxArrayHandle a, MlxArrayHandle b, MlxStreamHandle s);
    ...
    public static partial int RepeatAxis(out MlxArrayHandle res, MlxArrayHandle arr, int repeats, int axis, MlxStreamHandle s);
    ...
    public static partial int Repeat(out MlxArrayHandle res, MlxArrayHandle arr, int repeats, MlxStreamHandle s);

    /// <summary>Gives a new shape to an array without changing its data.</summary>
    [LibraryImport(Common.Lib, EntryPoint = "mlx_reshape")]
    public static partial int Reshape(out MlxArrayHandle res, MlxArrayHandle a, int* shape, nuint shapeNum, MlxStreamHandle s);
    ...
    public static partial int RightShift(out MlxArrayHandle res, MlxArrayHandle a, MlxArrayHandle b, MlxStreamHandle s);

    /// <summary>Rolls the elements of the array along one axis.</summary>
    [LibraryImport(Common.Lib, EntryPoint = "mlx_roll_axis")]
    public static partial int RollAxis(out MlxArrayHandle res, MlxArrayHandle a, int* shift, nuint shiftNum, int axis, MlxStreamHandle s);
    ...
    public static partial int Roll(out MlxArrayHandle res, MlxArrayHandle a, int* shift, nuint shiftNum, MlxStreamHandle s);
    ...
    public static partial int Round(out MlxArrayHandle res, MlxArrayHandle a, int decimals, MlxStreamHandle s);

    /// <summary>Computes the reciprocal square root of each element.</summary>
    [LibraryImport(Common.Lib, EntryPoint = "mlx_rsqrt")]
    public static partial int Rsqrt(out MlxArrayHandle res, MlxArrayHandle a, MlxStreamHandle s);
    ...
    public static partial int Sigmoid(out MlxArrayHandle res, MlxArrayHandle a, MlxStreamHandle s);

    /// <summary>Computes the sign of each element.</summary>
    [LibraryImport(Common.Lib, EntryPoint = "mlx_sign")]
    public static partial int Sign(out MlxArrayHandle res, MlxArrayHandle a, MlxStreamHandle s);

    /// <summary>Computes the element-wise sine of the input.</summary>
    [LibraryImport(Common.Lib, EntryPoint = "mlx_sin")]
    public static partial int Sin(out MlxArrayHandle res, MlxArrayHandle a, MlxStreamHandle s);

    /// <summary>Computes the element-wise hyperbolic sine of the input.</summary>
    [LibraryImport(Common.Lib, EntryPoint = "mlx_sinh")]
    public static partial int Sinh(out MlxArrayHandle res, MlxArrayHandle a, MlxStreamHandle s);
    ...
    public static partial int Softmax(out MlxArrayHandle res, MlxArrayHandle a, [MarshalAs(UnmanagedType.I1)] bool precise, MlxStreamHandle s);
    ...
    public static partial int SortAxis(out MlxArrayHandle res, MlxArrayHandle a, int axis, MlxStreamHandle s);

    /// <summary>Returns a sorted copy of the flattened array.</summary>
    [LibraryImport(Common.Lib, EntryPoint = "mlx_sort")]
    public static partial int Sort(out MlxArrayHandle res, MlxArrayHandle a, MlxStreamHandle s);

    /// <summary>Splits an array into multiple sub-arrays.</summary>
    [LibraryImport(Common.Lib, EntryPoint = "mlx_split")]
    public static partial int Split(out MlxVectorArrayHandle res, MlxArrayHandle a, int numSplits, int axis, MlxStreamHandle s);
    ...
    public static partial int Sqrt(out MlxArrayHandle res, MlxArrayHandle a, MlxStreamHandle s);

    /// <summary>Computes the element-wise square of the array.</summary>
    [LibraryImport(Common.Lib, EntryPoint = "mlx_square")]
    public static partial int Square(out MlxArrayHandle res, MlxArrayHandle a, MlxStreamHandle s);

    /// <summary>Removes specific axes of length one from the array.</summary>
    [LibraryImport(Common.Lib, EntryPoint = "mlx_squeeze_axes")]
    public static partial int SqueezeAxes(out MlxArrayHandle res, MlxArrayHandle a, int* axes, nuint axesNum, MlxStreamHandle s);

    /// <summary>Removes a single axis of length one from the array.</summary>
    [LibraryImport(Common.Lib, EntryPoint = "mlx_squeeze_axis")]
    public static partial int SqueezeAxis(out MlxArrayHandle res, MlxArrayHandle a, int axis, MlxStreamHandle s);

    /// <summary>Removes all axes of length one from the array.</summary>
    [LibraryImport(Common.Lib, EntryPoint = "mlx_squeeze")]
    public static partial int Squeeze(out MlxArrayHandle res, MlxArrayHandle a, MlxStreamHandle s);

    /// <summary>Stacks multiple arrays along a specified axis.</summary>
    [LibraryImport(Common.Lib, EntryPoint = "mlx_stack_axis")]
    public static partial int StackAxis(out MlxArrayHandle res, MlxVectorArrayHandle arrays, int axis, MlxStreamHandle s);

    /// <summary>Stacks a sequence of arrays along a new axis.</summary>
    [LibraryImport(Common.Lib, EntryPoint = "mlx_stack")]
    public static partial int Stack(out MlxArrayHandle res, MlxVectorArrayHandle arrays, MlxStreamHandle s);
    ...
    public static partial int Std(out MlxArrayHandle res, MlxArrayHandle a, [MarshalAs(UnmanagedType.I1)] bool keepdims, int ddof, MlxStreamHandle s);

    /// <summary>Stops gradient computation for the given array.</summary>
    [LibraryImport(Common.Lib, EntryPoint = "mlx_stop_gradient")]
    public static partial int StopGradient(out MlxArrayHandle res, MlxArrayHandle a, MlxStreamHandle s);

    /// <summary>Computes the element-wise difference of two arrays.</summary>
    [LibraryImport(Common.Lib, EntryPoint = "mlx_subtract")]
    public static partial int Subtract(out MlxArrayHandle res, MlxArrayHandle a, MlxArrayHandle b, MlxStreamHandle s);
    ...
    public static partial int Sum(out MlxArrayHandle res, MlxArrayHandle a, [MarshalAs(UnmanagedType.I1)] bool keepdims, MlxStreamHandle s);

    /// <summary>Swaps two axes of an array.</summary>
    [LibraryImport(Common.Lib, EntryPoint = "mlx_swapaxes")]
    public static partial int Swapaxes(out MlxArrayHandle res, MlxArrayHandle a, int axis1, int axis2, MlxStreamHandle s);

    /// <summary>Takes elements from an array along the specified axis.</summary>
    [LibraryImport(Common.Lib, EntryPoint = "mlx_take_axis")]
    public static partial int TakeAxis(out MlxArrayHandle res, MlxArrayHandle a, MlxArrayHandle indices, int axis, MlxStreamHandle s);

    /// <summary>Takes elements from the array at the given indices.</summary>
    [LibraryImport(Common.Lib, EntryPoint = "mlx_take")]
    public static partial int Take(out MlxArrayHandle res, MlxArrayHandle a, MlxArrayHandle indices, MlxStreamHandle s);
    ...
    public static partial int TakeAlongAxis(out MlxArrayHandle res, MlxArrayHandle a, MlxArrayHandle indices, int axis, MlxStreamHandle s);

    /// <summary>Computes the element-wise tangent of the input.</summary>
    [LibraryImport(Common.Lib, EntryPoint = "mlx_tan")]
    public static partial int Tan(out MlxArrayHandle res, MlxArrayHandle a, MlxStreamHandle s);

    /// <summary>Computes the element-wise hyperbolic tangent of the input.</summary>
    [LibraryImport(Common.Lib, EntryPoint = "mlx_tanh")]
    public static partial int Tanh(out MlxArrayHandle res, MlxArrayHandle a, MlxStreamHandle s);
    ...
    public static partial int TensordotAxis(out MlxArrayHandle res, MlxArrayHandle a, MlxArrayHandle b, int axis, MlxStreamHandle s);
    ...
    public static partial int Tile(out MlxArrayHandle res, MlxArrayHandle arr, int* reps, nuint repsNum, MlxStreamHandle s);
    ...
    public static partial int TopkAxis(out MlxArrayHandle res, MlxArrayHandle a, int k, int axis, MlxStreamHandle s);

    /// <summary>Returns the top-k largest elements of the array.</summary>
    [LibraryImport(Common.Lib, EntryPoint = "mlx_topk")]
    public static partial int Topk(out MlxArrayHandle res, MlxArrayHandle a, int k, MlxStreamHandle s);

    /// <summary>Computes the trace of a matrix.</summary>
    [LibraryImport(Common.Lib, EntryPoint = "mlx_trace")]
    public static partial int Trace(out MlxArrayHandle res, MlxArrayHandle a, int offset, int axis1, int axis2, MlxDType dtype, MlxStreamHandle s);

    /// <summary>Permutes the array’s axes to a given order.</summary>
    [LibraryImport(Common.Lib, EntryPoint = "mlx_transpose_axes")]
    public static partial int TransposeAxes(out MlxArrayHandle res, MlxArrayHandle a, int* axes, nuint axesNum, MlxStreamHandle s);

    /// <summary>Transposes the array dimensions.</summary>
    [LibraryImport(Common.Lib, EntryPoint = "mlx_transpose")]
    public static partial int Transpose(out MlxArrayHandle res, MlxArrayHandle a, MlxStreamHandle s);

    /// <summary>Constructs a matrix with ones on and below a given diagonal.</summary>
    [LibraryImport(Common.Lib, EntryPoint = "mlx_tri")]
    public static partial int Tri(out MlxArrayHandle res, int n, int m, int k, MlxDType type, MlxStreamHandle s);

    /// <summary>Returns the lower-triangular part of a matrix.</summary>
    [LibraryImport(Common.Lib, EntryPoint = "mlx_tril")]
    public static partial int Tril(out MlxArrayHandle res, MlxArrayHandle x, int k, MlxStreamHandle s);

    /// <summary>Returns the upper-triangular part of a matrix.</summary>
    [LibraryImport(Common.Lib, EntryPoint = "mlx_triu")]
    public static partial int Triu(out MlxArrayHandle res, MlxArrayHandle x, int k, MlxStreamHandle s);
    ...
    public static partial int Unflatten(out MlxArrayHandle res, MlxArrayHandle a, int axis, int* shape, nuint shapeNum, MlxStreamHandle s);
    ...
    public static partial int Var(out MlxArrayHandle res, MlxArrayHandle a, [MarshalAs(UnmanagedType.I1)] bool keepdims, int ddof, MlxStreamHandle s);

    /// <summary>Creates a view of the array sharing the same data.</summary>
    [LibraryImport(Common.Lib, EntryPoint = "mlx_view")]
    public static partial int View(out MlxArrayHandle res, MlxArrayHandle a, MlxDType dtype, MlxStreamHandle s);

    /// <summary>Selects elements from two arrays based on a condition.</summary>
    [LibraryImport(Common.Lib, EntryPoint = "mlx_where")]
    public static partial int Where(out MlxArrayHandle res, MlxArrayHandle condition, MlxArrayHandle x, MlxArrayHandle y, MlxStreamHandle s);
    ...
    public static partial int Zeros(out MlxArrayHandle res, int* shape, nuint shapeNum, MlxDType dtype, MlxStreamHandle s);
    ...
    public static partial int ZerosLike(out MlxArrayHandle res, MlxArrayHandle a, MlxStreamHandle s);
}
