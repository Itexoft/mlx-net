...
public static unsafe partial class MlxDistributed
{
    ...
    public static partial int AllGather(out MlxArrayHandle res, MlxArrayHandle x, MlxDistributedGroupHandle group, MlxStreamHandle s);
    ...
    public static partial int AllMax(out MlxArrayHandle res, MlxArrayHandle x, MlxDistributedGroupHandle group, MlxStreamHandle s);
    ...
    public static partial int AllMin(out MlxArrayHandle res, MlxArrayHandle x, MlxDistributedGroupHandle group, MlxStreamHandle s);
    ...
    public static partial int AllSum(out MlxArrayHandle res, MlxArrayHandle x, MlxDistributedGroupHandle group, MlxStreamHandle s);
    ...
    public static partial int RecvLike(out MlxArrayHandle res, MlxArrayHandle x, int src, MlxDistributedGroupHandle group, MlxStreamHandle s);
    ...
    public static partial int Send(out MlxArrayHandle res, MlxArrayHandle x, int dst, MlxDistributedGroupHandle group, MlxStreamHandle s);
    ...
    public static partial int SumScatter(out MlxArrayHandle res, MlxArrayHandle x, MlxDistributedGroupHandle group, MlxStreamHandle s);
}
