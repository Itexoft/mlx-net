...
public static partial class MlxStream
{
    ...
    public static partial MlxStreamHandle NewDevice(MlxDeviceHandle dev);

    /// <summary>
    /// Sets the current default stream to a given stream.
    /// </summary>
    [LibraryImport(Common.Lib, EntryPoint = "mlx_stream_set")]
    public static partial int Set(ref MlxStreamHandle stream, MlxStreamHandle src);

    /// <summary>
    /// Frees a stream object and releases its resources.
    /// </summary>
    [LibraryImport(Common.Lib, EntryPoint = "mlx_stream_free")]
    public static partial int Free(MlxStreamHandle stream);

    /// <summary>
    /// Returns a string representation of the stream.
    /// </summary>
    [LibraryImport(Common.Lib, EntryPoint = "mlx_stream_tostring")]
    public static partial int ToString(out MlxStringHandle str, MlxStreamHandle stream);
    ...
    public static partial int SetDefaultStream(MlxStreamHandle stream);
