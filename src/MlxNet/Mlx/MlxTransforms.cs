...
public static unsafe partial class MlxTransforms
{
    ...
    public static partial int AsyncEval(MlxVectorArrayHandle outputs);
    ...
    public static partial int Checkpoint(out MlxClosureHandle res, MlxClosureHandle fun);
    ...
    public static partial int CustomVjp(out MlxClosureHandle res, MlxClosureHandle fun, MlxClosureCustomHandle funVjp);
    ...
    public static partial int Eval(MlxVectorArrayHandle outputs);
    ...
    public static partial int ValueAndGrad(out MlxClosureValueAndGradHandle res, MlxClosureHandle fun, int* argnums, nuint argnumsNum);
    ...
    public static partial int DetailVmapReplace(
        ...
        MlxVectorArrayHandle sInputs,
        MlxVectorArrayHandle sOutputs,
        int* inAxes,
        nuint inAxesNum,
        int* outAxes,
        nuint outAxesNum);
