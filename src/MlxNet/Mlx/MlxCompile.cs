...
{
    MlxCompileModeDisabled,
    MlxCompileModeNoSimplify,
    MlxCompileModeNoFuse,
    MlxCompileModeEnabled,
}
...
public static unsafe partial class MlxCompile
{
    ...
    public static partial int Compile(out MlxClosureHandle res, MlxClosureHandle fun, [MarshalAs(UnmanagedType.I1)] bool shapeless);
    ...
    public static partial int DetailCompileErase(nuint funId);
    ...
    public static partial int SetCompileMode(MlxCompileMode mode);
}
