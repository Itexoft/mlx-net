...
public enum MlxDType
{
    ...
    MLX_BOOL = MlxBool,
    MLX_UINT8 = MlxUint8,
    MLX_UINT16 = MlxUint16,
    MLX_UINT32 = MlxUint32,
    MLX_UINT64 = MlxUint64,
    MLX_INT8 = MlxInt8,
    MLX_INT16 = MlxInt16,
    MLX_INT32 = MlxInt32,
    MLX_INT64 = MlxInt64,
    MLX_FLOAT16 = MlxFloat16,
    MLX_FLOAT32 = MlxFloat32,
    MLX_FLOAT64 = MlxFloat64,
    MLX_BFLOAT16 = MlxBfloat16,
    MLX_COMPLEX64 = MlxComplex64,
}
...
public static unsafe partial class MlxArray
{
    ...
    public static partial nuint DTypeSize(MlxDType dtype);
    ...
    public static partial int ToString(out MlxStringHandle str, MlxArrayHandle arr);
    ...
    public static partial int Free(MlxArrayHandle arr);

    /// <summary>Creates a new boolean array of the specified shape.</summary>
    [LibraryImport(Common.Lib, EntryPoint = "mlx_array_new_bool")]
    public static partial MlxArrayHandle NewBool([MarshalAs(UnmanagedType.I1)] bool val);
    ...
    public static partial MlxArrayHandle NewFloat(float val);

    /// <summary>Creates a new array of dtype float64.</summary>
    [LibraryImport(Common.Lib, EntryPoint = "mlx_array_new_float64")]
    public static partial MlxArrayHandle NewFloat64(double val);
    ...
    public static partial MlxArrayHandle NewDouble(double val);
    ...
    public static partial MlxArrayHandle NewComplex(float realVal, float imagVal);
    ...
    public static partial MlxArrayHandle NewData(void* data, int* shape, int dim, MlxDType dtype);
    ...
    public static partial int Set(ref MlxArrayHandle arr, MlxArrayHandle src);

    /// <summary>Fills the array with a given boolean value.</summary>
    [LibraryImport(Common.Lib, EntryPoint = "mlx_array_set_bool")]
    public static partial int SetBool(ref MlxArrayHandle arr, [MarshalAs(UnmanagedType.I1)] bool val);

    /// <summary>Fills the array with a given integer value.</summary>
    [LibraryImport(Common.Lib, EntryPoint = "mlx_array_set_int")]
    public static partial int SetInt(ref MlxArrayHandle arr, int val);
    ...
    public static partial int SetFloat32(ref MlxArrayHandle arr, float val);
    ...
    public static partial int SetFloat(ref MlxArrayHandle arr, float val);
    ...
    public static partial int SetFloat64(ref MlxArrayHandle arr, double val);
    ...
    public static partial int SetDouble(ref MlxArrayHandle arr, double val);

    /// <summary>Fills the array with a given complex value.</summary>
    [LibraryImport(Common.Lib, EntryPoint = "mlx_array_set_complex")]
    public static partial int SetComplex(ref MlxArrayHandle arr, float realVal, float imagVal);
    ...
    public static partial int SetData(ref MlxArrayHandle arr, void* data, int* shape, int dim, MlxDType dtype);
    ...
    public static partial int ItemBool(out byte res, MlxArrayHandle arr);
    ...
    public static partial int ItemUint8(out byte res, MlxArrayHandle arr);
    ...
    public static partial int ItemUint16(out ushort res, MlxArrayHandle arr);
    ...
    public static partial int ItemUint32(out uint res, MlxArrayHandle arr);
    ...
    public static partial int ItemUint64(out ulong res, MlxArrayHandle arr);
    ...
    public static partial int ItemInt8(out sbyte res, MlxArrayHandle arr);
    ...
    public static partial int ItemInt16(out short res, MlxArrayHandle arr);
    ...
    public static partial int ItemInt32(out int res, MlxArrayHandle arr);
    ...
    public static partial int ItemInt64(out long res, MlxArrayHandle arr);
    ...
    public static partial int ItemFloat32(out float res, MlxArrayHandle arr);
    ...
    public static partial int ItemFloat64(out double res, MlxArrayHandle arr);
    ...
    public static partial int ItemComplex64(out Complex64 res, MlxArrayHandle arr);
    ...
    public static partial int ItemFloat16(out ushort res, MlxArrayHandle arr);
    ...
    public static partial int ItemBfloat16(out ushort res, MlxArrayHandle arr);
    ...
    public static partial byte* DataBool(MlxArrayHandle arr);
    ...
    public static partial byte* DataUint8(MlxArrayHandle arr);
    ...
    public static partial ushort* DataUint16(MlxArrayHandle arr);
    ...
    public static partial uint* DataUint32(MlxArrayHandle arr);
    ...
    public static partial ulong* DataUint64(MlxArrayHandle arr);
    ...
    public static partial sbyte* DataInt8(MlxArrayHandle arr);
    ...
    public static partial short* DataInt16(MlxArrayHandle arr);
    ...
    public static partial int* DataInt32(MlxArrayHandle arr);
    ...
    public static partial long* DataInt64(MlxArrayHandle arr);
    ...
    public static partial float* DataFloat32(MlxArrayHandle arr);
    ...
    public static partial double* DataFloat64(MlxArrayHandle arr);
    ...
    public static partial Complex64* DataComplex64(MlxArrayHandle arr);
    ...
    public static partial ushort* DataFloat16(MlxArrayHandle arr);
    ...
    public static partial int IsRowContiguous(out byte res, MlxArrayHandle arr);
    ...
    public static partial int IsColContiguous(out byte res, MlxArrayHandle arr);
}
