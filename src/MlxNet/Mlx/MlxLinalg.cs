...
public static unsafe partial class MlxLinalg
{
    ...
    public static partial int Cholesky(out MlxArrayHandle res, MlxArrayHandle a, [MarshalAs(UnmanagedType.I1)] bool upper, MlxStreamHandle s);
    ...
    public static partial int CholeskyInv(out MlxArrayHandle res, MlxArrayHandle a, [MarshalAs(UnmanagedType.I1)] bool upper, MlxStreamHandle s);
    ...
    public static partial int Cross(out MlxArrayHandle res, MlxArrayHandle a, MlxArrayHandle b, int axis, MlxStreamHandle s);
    ...
    public static partial int Eig(out MlxArrayHandle res0, out MlxArrayHandle res1, MlxArrayHandle a, MlxStreamHandle s);
    ...
    public static partial int Eigh(
        out MlxArrayHandle res0,
        out MlxArrayHandle res1,
        MlxArrayHandle a,
    ...
    public static partial int Eigvals(out MlxArrayHandle res, MlxArrayHandle a, MlxStreamHandle s);
    ...
    public static partial int Eigvalsh(out MlxArrayHandle res, MlxArrayHandle a, [MarshalAs(UnmanagedType.LPUTF8Str)] string uplo, MlxStreamHandle s);

    /// <summary>Computes the inverse of a square matrix.</summary>
    [LibraryImport(Common.Lib, EntryPoint = "mlx_linalg_inv")]
    public static partial int Inv(out MlxArrayHandle res, MlxArrayHandle a, MlxStreamHandle s);
    ...
    public static partial int Lu(out MlxVectorArrayHandle res, MlxArrayHandle a, MlxStreamHandle s);
    ...
    public static partial int LuFactor(out MlxArrayHandle res0, out MlxArrayHandle res1, MlxArrayHandle a, MlxStreamHandle s);
    ...
    public static partial int Pinv(out MlxArrayHandle res, MlxArrayHandle a, MlxStreamHandle s);
    ...
    public static partial int Qr(out MlxArrayHandle res0, out MlxArrayHandle res1, MlxArrayHandle a, MlxStreamHandle s);
    ...
    public static partial int Solve(out MlxArrayHandle res, MlxArrayHandle a, MlxArrayHandle b, MlxStreamHandle s);
    ...
    public static partial int Svd(out MlxVectorArrayHandle res, MlxArrayHandle a, [MarshalAs(UnmanagedType.I1)] bool computeUv, MlxStreamHandle s);
    ...
    public static partial int TriInv(out MlxArrayHandle res, MlxArrayHandle a, [MarshalAs(UnmanagedType.I1)] bool upper, MlxStreamHandle s);
}
