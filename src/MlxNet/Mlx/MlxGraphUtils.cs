...
public static partial class MlxGraphUtils
{
    ...
    public static partial int NodeNamerFree(MlxNodeNamer namer);
    ...
    public static partial int NodeNamerSetName(MlxNodeNamer namer, MlxArrayHandle arr, [MarshalAs(UnmanagedType.LPUTF8Str)] string name);
    ...
    public static partial int NodeNamerGetName(out nint name, MlxNodeNamer namer, MlxArrayHandle arr);
    ...
    public static partial int ExportToDot(nint os, MlxNodeNamer namer, MlxVectorArrayHandle outputs);
    ...
    public static partial int PrintGraph(nint os, MlxNodeNamer namer, MlxVectorArrayHandle outputs);
}
