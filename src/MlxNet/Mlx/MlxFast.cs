...
public static unsafe partial class MlxFast
{
    ...
    public static partial void CudaKernelConfigFree(MlxFastCudaKernelConfig cls);
    ...
    public static partial int CudaKernelConfigAddOutputArg(MlxFastCudaKernelConfig cls, int* shape, nuint size, MlxDType dtype);
    ...
    public static partial int CudaKernelConfigSetGrid(MlxFastCudaKernelConfig cls, int grid1, int grid2, int grid3);
    ...
    public static partial int CudaKernelConfigSetThreadGroup(MlxFastCudaKernelConfig cls, int thread1, int thread2, int thread3);
    ...
    public static partial int CudaKernelConfigSetInitValue(MlxFastCudaKernelConfig cls, float value);
    ...
    public static partial int CudaKernelConfigSetVerbose(MlxFastCudaKernelConfig cls, [MarshalAs(UnmanagedType.I1)] bool verbose);

    /// <summary>Adds a dtype template argument to a CUDA kernel configuration.</summary>
    [LibraryImport(Common.Lib, EntryPoint = "mlx_fast_cuda_kernel_config_add_template_arg_dtype", StringMarshalling = StringMarshalling.Utf8)]
    ...
    [LibraryImport(Common.Lib, EntryPoint = "mlx_fast_cuda_kernel_config_add_template_arg_int", StringMarshalling = StringMarshalling.Utf8)]
    ...
    [LibraryImport(Common.Lib, EntryPoint = "mlx_fast_cuda_kernel_config_add_template_arg_bool", StringMarshalling = StringMarshalling.Utf8)]
    ...
    public static partial MlxFastCudaKernel CudaKernelNew(
        [MarshalAs(UnmanagedType.LPUTF8Str)] string name,
        MlxVectorStringHandle inputNames,
        MlxVectorStringHandle outputNames,
    ...
    public static partial void CudaKernelFree(MlxFastCudaKernel cls);
    ...
    public static partial void MetalKernelConfigFree(MlxFastMetalKernelConfig cls);
    ...
    public static partial int MetalKernelConfigAddOutputArg(MlxFastMetalKernelConfig cls, int* shape, nuint size, MlxDType dtype);
    ...
    public static partial int MetalKernelConfigSetGrid(MlxFastMetalKernelConfig cls, int grid1, int grid2, int grid3);
    ...
    public static partial int MetalKernelConfigSetThreadGroup(MlxFastMetalKernelConfig cls, int thread1, int thread2, int thread3);
    ...
    public static partial int MetalKernelConfigSetInitValue(MlxFastMetalKernelConfig cls, float value);
    ...
    public static partial int MetalKernelConfigSetVerbose(MlxFastMetalKernelConfig cls, [MarshalAs(UnmanagedType.I1)] bool verbose);

    /// <summary>Sets a data-type template parameter for a Metal kernel configuration (choosing a type in shader code).</summary>
    [LibraryImport(Common.Lib, EntryPoint = "mlx_fast_metal_kernel_config_add_template_arg_dtype", StringMarshalling = StringMarshalling.Utf8)]
    ...
    [LibraryImport(Common.Lib, EntryPoint = "mlx_fast_metal_kernel_config_add_template_arg_int", StringMarshalling = StringMarshalling.Utf8)]
    ...
    [LibraryImport(Common.Lib, EntryPoint = "mlx_fast_metal_kernel_config_add_template_arg_bool", StringMarshalling = StringMarshalling.Utf8)]
    ...
    public static partial void MetalKernelFree(MlxFastMetalKernel cls);
    ...
    public static partial int RmsNorm(out MlxArrayHandle res, MlxArrayHandle x, MlxArrayHandle weight, float eps, MlxStreamHandle s);
    ...
    public static partial int ScaledDotProductAttention(
        ...
        float scale,
        [MarshalAs(UnmanagedType.LPUTF8Str)] string maskMode,
        MlxArrayHandle maskArr,
