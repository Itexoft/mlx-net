...
public static unsafe partial class MlxVector
{
    ...
    public static partial int ArraySet(ref MlxVectorArrayHandle vec, MlxVectorArrayHandle src);

    /// <summary>
    /// Frees a dynamic vector that holds MLX array objects.
    /// </summary>
    [LibraryImport(Common.Lib, EntryPoint = "mlx_vector_array_free")]
    public static partial int ArrayFree(MlxVectorArrayHandle vec);
    ...
    public static partial MlxVectorArrayHandle ArrayNewData(MlxArrayHandle* data, nuint size);
    ...
    public static partial MlxVectorArrayHandle ArrayNewValue(MlxArrayHandle val);
    ...
    public static partial int ArraySetData(ref MlxVectorArrayHandle vec, MlxArrayHandle* data, nuint size);
    ...
    public static partial int ArraySetValue(ref MlxVectorArrayHandle vec, MlxArrayHandle val);
    ...
    public static partial int ArrayAppendData(MlxVectorArrayHandle vec, MlxArrayHandle* data, nuint size);
    ...
    public static partial int ArrayAppendValue(MlxVectorArrayHandle vec, MlxArrayHandle val);

    /// <summary>
    /// Returns the number of elements in the vector-of-arrays.
    /// </summary>
    [LibraryImport(Common.Lib, EntryPoint = "mlx_vector_array_size")]
    public static partial nuint ArraySize(MlxVectorArrayHandle vec);

    /// <summary>
    /// Retrieves the MLX array at a given index in the vector-of-arrays.
    /// </summary>
    [LibraryImport(Common.Lib, EntryPoint = "mlx_vector_array_get")]
    public static partial int ArrayGet(out MlxArrayHandle res, MlxVectorArrayHandle vec, nuint idx);
    ...
    public static partial int VectorArraySet(ref MlxVectorVectorArrayHandle vec, MlxVectorVectorArrayHandle src);
    ...
    public static partial int VectorArrayFree(MlxVectorVectorArrayHandle vec);
    ...
    public static partial MlxVectorVectorArrayHandle VectorArrayNewData(MlxVectorArrayHandle* data, nuint size);
    ...
    public static partial MlxVectorVectorArrayHandle VectorArrayNewValue(MlxVectorArrayHandle val);
    ...
    public static partial int VectorArraySetData(ref MlxVectorVectorArrayHandle vec, MlxVectorArrayHandle* data, nuint size);
    ...
    public static partial int VectorArraySetValue(ref MlxVectorVectorArrayHandle vec, MlxVectorArrayHandle val);
    ...
    public static partial int VectorArrayAppendData(MlxVectorVectorArrayHandle vec, MlxVectorArrayHandle* data, nuint size);
    ...
    public static partial int VectorArrayAppendValue(MlxVectorVectorArrayHandle vec, MlxVectorArrayHandle val);
    ...
    public static partial nuint VectorArraySize(MlxVectorVectorArrayHandle vec);
    ...
    public static partial int VectorArrayGet(out MlxVectorArrayHandle res, MlxVectorVectorArrayHandle vec, nuint idx);
    ...
    public static partial int IntSet(ref MlxVectorIntHandle vec, MlxVectorIntHandle src);

    /// <summary>
    /// Frees a dynamic vector of integers.
    /// </summary>
    [LibraryImport(Common.Lib, EntryPoint = "mlx_vector_int_free")]
    public static partial int IntFree(MlxVectorIntHandle vec);
    ...
    public static partial MlxVectorIntHandle IntNewData(int* data, nuint size);
    ...
    public static partial MlxVectorIntHandle IntNewValue(int val);
    ...
    public static partial int IntSetData(ref MlxVectorIntHandle vec, int* data, nuint size);

    /// <summary>
    /// Sets the element at a given index to an integer value.
    /// </summary>
    [LibraryImport(Common.Lib, EntryPoint = "mlx_vector_int_set_value")]
    public static partial int IntSetValue(ref MlxVectorIntHandle vec, int val);
    ...
    public static partial int StringSet(ref MlxVectorStringHandle vec, MlxVectorStringHandle src);

    /// <summary>
    /// Frees a dynamic vector of strings.
    /// </summary>
    [LibraryImport(Common.Lib, EntryPoint = "mlx_vector_string_free")]
    public static partial int StringFree(MlxVectorStringHandle vec);
    ...
    public static partial MlxVectorStringHandle StringNewData(nint* data, nuint size);
    ...
    public static partial MlxVectorStringHandle StringNewValue([MarshalAs(UnmanagedType.LPUTF8Str)] string val);
    ...
    public static partial int StringSetData(ref MlxVectorStringHandle vec, nint* data, nuint size);
    ...
    public static partial int StringSetValue(ref MlxVectorStringHandle vec, [MarshalAs(UnmanagedType.LPUTF8Str)] string val);
    ...
    public static partial int StringAppendData(MlxVectorStringHandle vec, nint* data, nuint size);
    ...
    public static partial int StringAppendValue(MlxVectorStringHandle vec, [MarshalAs(UnmanagedType.LPUTF8Str)] string val);

    /// <summary>
    /// Returns the number of string elements in the vector.
    /// </summary>
    [LibraryImport(Common.Lib, EntryPoint = "mlx_vector_string_size")]
    public static partial nuint StringSize(MlxVectorStringHandle vec);

    /// <summary>
    /// Retrieves the string at a given index in the vector-of-strings.
    /// </summary>
    [LibraryImport(Common.Lib, EntryPoint = "mlx_vector_string_get")]
    public static partial int StringGet(out nint res, MlxVectorStringHandle vec, nuint idx);
}
