...
public static partial class MlxMap
{
    ...
    public static partial int StringToArraySet(ref MlxMapStringToArrayHandle map, MlxMapStringToArrayHandle src);

    /// <summary>
    /// Frees a map that stores string keys to array values.
    /// </summary>
    [LibraryImport(Common.Lib, EntryPoint = "mlx_map_string_to_array_free")]
    public static partial int StringToArrayFree(MlxMapStringToArrayHandle map);
    ...
    public static partial MlxMapStringToArrayIteratorHandle StringToArrayIteratorNew(MlxMapStringToArrayHandle map);

    /// <summary>
    /// Frees an iterator over a string-to-array map.
    /// </summary>
    [LibraryImport(Common.Lib, EntryPoint = "mlx_map_string_to_array_iterator_free")]
    public static partial int StringToArrayIteratorFree(MlxMapStringToArrayIteratorHandle it);
    ...
    public static partial int StringToArrayIteratorNext(out nint key, out MlxArrayHandle value, MlxMapStringToArrayIteratorHandle it);
    ...
    public static partial int StringToStringSet(ref MlxMapStringToStringHandle map, MlxMapStringToStringHandle src);

    /// <summary>
    /// Frees a map that stores string keys to string values.
    /// </summary>
    [LibraryImport(Common.Lib, EntryPoint = "mlx_map_string_to_string_free")]
    public static partial int StringToStringFree(MlxMapStringToStringHandle map);
    ...
    public static partial int StringToStringGet(out nint value, MlxMapStringToStringHandle map, [MarshalAs(UnmanagedType.LPUTF8Str)] string key);
    ...
    public static partial MlxMapStringToStringIteratorHandle StringToStringIteratorNew(MlxMapStringToStringHandle map);

    /// <summary>
    /// Frees an iterator over a string-to-string map.
    /// </summary>
    [LibraryImport(Common.Lib, EntryPoint = "mlx_map_string_to_string_iterator_free")]
    public static partial int StringToStringIteratorFree(MlxMapStringToStringIteratorHandle it);
    ...
    public static partial int StringToStringIteratorNext(out nint key, out nint value, MlxMapStringToStringIteratorHandle it);
}
