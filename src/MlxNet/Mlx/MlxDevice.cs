...
public static partial class MlxDevice
{
    ...
    public static partial int DeviceInfoGet(
        out MlxDeviceInfo info,
        MlxDeviceHandle dev
    );
    ...
    public static partial int DeviceInfoFree(
        MlxDeviceInfo info
    );
    ...
    public static partial int DeviceInfoGetString(
        out nint value,
        MlxDeviceInfo info,
        [MarshalAs(UnmanagedType.LPUTF8Str)] string key
    );
    ...
    public static partial int DeviceInfoGetSize(
        out nuint value,
        MlxDeviceInfo info,
        [MarshalAs(UnmanagedType.LPUTF8Str)] string key
    );
    ...
    public static partial int DeviceInfoGetKeys(
