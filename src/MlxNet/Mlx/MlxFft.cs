...
public static unsafe partial class MlxFft
{
    ...
    public static partial int Fft(out MlxArrayHandle res, MlxArrayHandle a, int n, int axis, MlxStreamHandle s);
    ...
    public static partial int Fft2(out MlxArrayHandle res, MlxArrayHandle a, int* n, nuint nNum, int* axes, nuint axesNum, MlxStreamHandle s);
    ...
    public static partial int Fftn(out MlxArrayHandle res, MlxArrayHandle a, int* n, nuint nNum, int* axes, nuint axesNum, MlxStreamHandle s);
    ...
    public static partial int Fftshift(out MlxArrayHandle res, MlxArrayHandle a, int* axes, nuint axesNum, MlxStreamHandle s);
    ...
    public static partial int Ifft(out MlxArrayHandle res, MlxArrayHandle a, int n, int axis, MlxStreamHandle s);
    ...
    public static partial int Ifft2(out MlxArrayHandle res, MlxArrayHandle a, int* n, nuint nNum, int* axes, nuint axesNum, MlxStreamHandle s);
    ...
    public static partial int Ifftn(out MlxArrayHandle res, MlxArrayHandle a, int* n, nuint nNum, int* axes, nuint axesNum, MlxStreamHandle s);
    ...
    public static partial int Ifftshift(out MlxArrayHandle res, MlxArrayHandle a, int* axes, nuint axesNum, MlxStreamHandle s);
    ...
    public static partial int Irfft(out MlxArrayHandle res, MlxArrayHandle a, int n, int axis, MlxStreamHandle s);
    ...
    public static partial int Irfft2(out MlxArrayHandle res, MlxArrayHandle a, int* n, nuint nNum, int* axes, nuint axesNum, MlxStreamHandle s);
    ...
    public static partial int Irfftn(out MlxArrayHandle res, MlxArrayHandle a, int* n, nuint nNum, int* axes, nuint axesNum, MlxStreamHandle s);
    ...
    public static partial int Rfft(out MlxArrayHandle res, MlxArrayHandle a, int n, int axis, MlxStreamHandle s);
    ...
    public static partial int Rfft2(out MlxArrayHandle res, MlxArrayHandle a, int* n, nuint nNum, int* axes, nuint axesNum, MlxStreamHandle s);
    ...
    public static partial int Rfftn(out MlxArrayHandle res, MlxArrayHandle a, int* n, nuint nNum, int* axes, nuint axesNum, MlxStreamHandle s);
}
