...
public static partial class MlxExport
{
    ...
    public static partial int FunctionExporterFree(MlxFunctionExporter xfunc);
    ...
    public static partial int FunctionExporterApply(MlxFunctionExporter xfunc, MlxVectorArrayHandle args);
    ...
    public static partial int FunctionExporterApplyKwargs(MlxFunctionExporter xfunc, MlxVectorArrayHandle args, MlxMapStringToArrayHandle kwargs);
    ...
    public static partial MlxImportedFunction ImportedFunctionNew([MarshalAs(UnmanagedType.LPUTF8Str)] string file);
    ...
    public static partial int ImportedFunctionFree(MlxImportedFunction xfunc);
    ...
    public static partial int ImportedFunctionApply(out MlxVectorArrayHandle res, MlxImportedFunction xfunc, MlxVectorArrayHandle args);
